...
{
    public class ClientTypeService : Service<IClientTypeRepository, ClientType, ClientTypeDTO, int>, IClientTypeService
    {
        ...
        public ClientTypeService(
            ...
            : base(unitOfWork, unitOfWork.ClientTypeRepository)
        {
