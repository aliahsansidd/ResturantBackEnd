...
{
    public class BuildingFloorService : Service<IBuildingFloorRepository, BuildingFloor, BuildingFloorDTO, int>, IBuildingFloorService
    {
        ...
        public BuildingFloorService(
            ...
            : base(unitOfWork, unitOfWork.BuildingFloorRepository)
        {
