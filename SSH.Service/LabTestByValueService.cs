...
{
    public class LabTestByValueService : Service<ILabTestByValueRepository, LabTestByValue, LabTestByValueDTO, int>, ILabTestByValueService
    {
        ...
        public LabTestByValueService(
            ISSHUnitOfWork unitOfWork,
            ISSHRequestInfo requestInfo,
            IExceptionHelper exceptionHelper)
            : base(unitOfWork, unitOfWork.LabTestByValueRepository)
        {
