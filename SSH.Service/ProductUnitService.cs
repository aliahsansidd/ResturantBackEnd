...
{
    public class ProductUnitService : Service<IProductUnitRepository, ProductUnit, ProductUnitDTO, int>, IProductUnitService
    {
        ...
        public ProductUnitService(
            ...
            : base(unitOfWork, unitOfWork.ProductUnitRepository)
        {
