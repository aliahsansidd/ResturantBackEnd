...
{
    public class ProductTypeService : Service<IProductTypeRepository, ProductType, ProductTypeDTO, int>, IProductTypeService
    {
        ...
        public ProductTypeService(
            ...
            : base(unitOfWork, unitOfWork.ProductTypeRepository)
        {
