...
{
    public class CatastrophicEventService : Service<ICatastrophicEventRepository, CatastrophicEvent, CatastrophicEventDTO, int>, ICatastrophicEventService
    {
        ...
        public CatastrophicEventService(
            ISSHUnitOfWork unitOfWork,
            ISSHRequestInfo requestInfo,
            IExceptionHelper exceptionHelper)
            : base(unitOfWork, unitOfWork.CatastrophicEventRepository)
        {
