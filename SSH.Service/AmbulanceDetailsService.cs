...
{
    public class AmbulanceDetailsService : Service<IAmbulanceDetailsRepository, AmbulanceDetails, AmbulanceDetailsDTO, int>, IAmbulanceDetailsService
    {
        ...
        public AmbulanceDetailsService(
            ISSHUnitOfWork unitOfWork,
            ISSHRequestInfo requestInfo,
            IExceptionHelper exceptionHelper)
            : base(unitOfWork, unitOfWork.AmbulanceDetailsRepository)
        {
