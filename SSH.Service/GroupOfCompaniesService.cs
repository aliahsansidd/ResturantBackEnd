...
{
    public class GroupOfCompaniesService : Service<IGroupOfCompaniesRepository, GroupOfCompanies, GroupOfCompaniesDTO, int>, IGroupOfCompaniesService
    {
        ...
        public GroupOfCompaniesService(
            ISSHUnitOfWork unitOfWork,
            ISSHRequestInfo requestInfo,
            IExceptionHelper exceptionHelper)
            : base(unitOfWork, unitOfWork.GroupOfCompaniesRepository)
        {
