...
{
    [CustomAuthorize]
    [RoutePrefix("GroupOfCompanies")]
    public class GroupOfCompaniesController : Controller<IGroupOfCompaniesService, GroupOfCompaniesDTO, GroupOfCompanies, int>
    {
        public GroupOfCompaniesController(IGroupOfCompaniesService service)
            : base(service)
        {
        }
        ...
        [HttpPost]
        [Route("Create")]
        public async Task<ResponseMessageResult> CreateBed(GroupOfCompaniesDTO dtoObject)
        {
        ...
        [HttpPut]
        [Route("Update")]
        public async Task<ResponseMessageResult> UpdateBed(GroupOfCompaniesDTO dtoObject)
        {
