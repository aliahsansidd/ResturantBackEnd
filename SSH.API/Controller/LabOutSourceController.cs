...
{
    [CustomAuthorize]
    [RoutePrefix("LabOutSource")]
    public class LabOutSourceController : Controller<ILabOutSourceService, LabOutSourceDTO, LabOutSource, int>
    {
        public LabOutSourceController(ILabOutSourceService service)
            : base(service)
        {
        }
        ...
        [HttpPost]
        [Route("Create")]
        public async Task<ResponseMessageResult> CreateLabOutSource(LabOutSourceDTO dtoObject)
        {
        ...
        [HttpPut]
        [Route("Update")]
        public async Task<ResponseMessageResult> UpdateLabOutSource(LabOutSourceDTO dtoObject)
        {
        ...
        [HttpDelete]
        [Route("Delete")]
        public async Task<ResponseMessageResult> DeleteLabOutSource(int id)
        {
