...
{
    [CustomAuthorize]
    [RoutePrefix("RateSheet")]
    public class RateSheetController : Controller<IRateSheetService, RateSheetDTO, RateSheet, int>
    {
        public RateSheetController(IRateSheetService service)
            : base(service)
        {
        }
        ...
        [HttpPost]
        [Route("Create")]
        public async Task<ResponseMessageResult> CreateRateSheet(RateSheetDTO dtoObject)
        {
        ...
        [HttpPut]
        [Route("Update")]
        public async Task<ResponseMessageResult> UpdateRateSheet(RateSheetDTO dtoObject)
        {
        ...
        [HttpDelete]
        [Route("Delete")]
        public async Task<ResponseMessageResult> DeleteRateSheet(int id)
        {
