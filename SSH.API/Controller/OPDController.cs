...
namespace SSH.API.Controller
{
    [CustomAuthorize]
    [RoutePrefix("OPD")]
    public class OPDController : Controller<IOPDService, OPDDTO, OPD, int>
    {
        public OPDController(IOPDService service)
            : base(service)
        {
        }
        ...
        [HttpPost]
        [Route("Create")]
        public async Task<ResponseMessageResult> CreateOPD(OPDDTO dtoObject)
        {
        ...
        [HttpPut]
        [Route("Update")]
        public async Task<ResponseMessageResult> UpdateOPD(OPDDTO dtoObject)
        {
        ...
        [HttpDelete]
        [Route("Delete")]
        public async Task<ResponseMessageResult> DeleteOPD(int id)
        {
