...
{
    [CustomAuthorize]
    [RoutePrefix("LabTestBuilder")]
    public class LabTestBuilderController : Controller<ILabTestBuilderService, LabTestBuilderDTO, LabTestBuilder, int>
    {
        public LabTestBuilderController(ILabTestBuilderService service)
            : base(service)
        {
        }
        ...
        [HttpPost]
        [Route("Create")]
        public async Task<ResponseMessageResult> CreateLabTestBuilder(LabTestBuilderDTO dtoObject)
        {
        ...
        [HttpPut]
        [Route("Update")]
        public async Task<ResponseMessageResult> UpdateLabTestBuilder(LabTestBuilderDTO dtoObject)
        {
        ...
        [HttpDelete]
        [Route("Delete")]
        public async Task<ResponseMessageResult> DeleteLabTestBuilder(int id)
        {
