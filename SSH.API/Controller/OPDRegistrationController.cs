...
{
    [CustomAuthorize]
    [RoutePrefix("OPDRegistration")]
    public class OPDRegistrationController : Controller<IOPDRegistrationService, OPDRegistrationDTO, OPDRegistration, int>
    {
        public OPDRegistrationController(IOPDRegistrationService service)
            : base(service)
        {
        }
        ...
        [HttpPost]
        [Route("Create")]
        public async Task<ResponseMessageResult> CreateOPDRegistration(OPDRegistrationDTO dtoObject)
        {
        ...
        [HttpPut]
        [Route("Update")]
        public async Task<ResponseMessageResult> UpdateOPDRegistration(OPDRegistrationDTO dtoObject)
        {
        ...
        [HttpDelete]
        [Route("Delete")]
        public async Task<ResponseMessageResult> DeleteOPDRegistration(int id)
        {
