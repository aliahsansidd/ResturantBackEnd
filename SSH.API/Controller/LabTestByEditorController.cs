...
{
    [CustomAuthorize]
    [RoutePrefix("LabTestByEditor")]
    public class LabTestByEditorController : Controller<ILabTestByEditorService, LabTestByEditorDTO, LabTestByEditor, int>
    {
        public LabTestByEditorController(ILabTestByEditorService service)
            : base(service)
        {
        }
        ...
        [HttpPost]
        [Route("Create")]
        public async Task<ResponseMessageResult> CreateLabTestByEditor(LabTestByEditorDTO dtoObject)
        {
        ...
        [HttpPut]
        [Route("Update")]
        public async Task<ResponseMessageResult> UpdateLabTestByEditor(LabTestByEditorDTO dtoObject)
        {
        ...
        [HttpDelete]
        [Route("Delete")]
        public async Task<ResponseMessageResult> DeleteLabTestByEditor(int id)
        {
