...
{
    [CustomAuthorize]
    [RoutePrefix("BuildingFloor")]
    public class BuildingFloorController : Controller<IBuildingFloorService, BuildingFloorDTO, BuildingFloor, int>
    {
        ...
        [HttpPost]
        [Route("Create")]
        public async Task<ResponseMessageResult> CreateBed(BuildingFloorDTO dtoObject)
        {
        ...
        [HttpPut]
        [Route("Update")]
        public async Task<ResponseMessageResult> UpdateBed(BuildingFloorDTO dtoObject)
        {
