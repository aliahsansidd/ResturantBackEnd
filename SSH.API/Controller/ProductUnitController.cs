...
{
    [CustomAuthorize]
    [RoutePrefix("ProductUnit")]
    public class ProductUnitController : Controller<IProductUnitService, ProductUnitDTO, ProductUnit, int>
    {
        ...
        [HttpPost]
        [Route("Create")]
        public async Task<ResponseMessageResult> CreateProductUnit(ProductUnitDTO dtoObject)
        {
        ...
        [HttpPut]
        [Route("Update")]
        public async Task<ResponseMessageResult> UpdateProductUnit(ProductUnitDTO dtoObject)
        {
        ...
        [HttpDelete]
        [Route("Delete")]
        public async Task<ResponseMessageResult> DeleteProductUnit(int id)
        {
