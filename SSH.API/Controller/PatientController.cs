...
namespace SSH.API.Controller
{
    [CustomAuthorize]
    [RoutePrefix("Patient")]
    public class PatientController : Controller<IPatientService, PatientDTO, Patient, int>
    {
        ...
        [HttpPost]
        [Route("Create")]
        public async Task<ResponseMessageResult> CreatePatient(PatientDTO dtoObject)
        {
        ...
        [HttpPut]
        [Route("Update")]
        public async Task<ResponseMessageResult> UpdatePatient(PatientDTO dtoObject)
        {
        ...
        [HttpDelete]
        [Route("Delete")]
        public async Task<ResponseMessageResult> DeletePatient(int id)
        {
