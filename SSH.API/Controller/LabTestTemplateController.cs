...
{
    [CustomAuthorize]
    [RoutePrefix("LabTestTemplate")]
    public class LabTestTemplateController : Controller<ILabTestTemplateService, LabTestTemplateDTO, LabTestTemplate, int>
    {
        public LabTestTemplateController(ILabTestTemplateService service)
            : base(service)
        {
        }
        ...
        [HttpPost]
        [Route("Create")]
        public async Task<ResponseMessageResult> CreateLabTestTemplate(LabTestTemplateDTO dtoObject)
        {
        ...
        [HttpPut]
        [Route("Update")]
        public async Task<ResponseMessageResult> UpdateLabTestTemplate(LabTestTemplateDTO dtoObject)
        {
        ...
        [HttpDelete]
        [Route("Delete")]
        public async Task<ResponseMessageResult> DeleteLabTestTemplate(int id)
        {
