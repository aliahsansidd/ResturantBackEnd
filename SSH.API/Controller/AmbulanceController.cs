...
namespace SSH.API.Controller
{
    ...
    public class AmbulanceController : Controller<IAmbulanceService, AmbulanceDTO, Ambulance, int>
    {
        ...
        [HttpPost]
        [Route("Create")]
        public async Task<ResponseMessageResult> CreateAmbulance(AmbulanceDTO dtoObject)
        {
        ...
        [HttpPut]
        [Route("Update")]
        public async Task<ResponseMessageResult> UpdateAmbulance(AmbulanceDTO dtoObject)
        {
