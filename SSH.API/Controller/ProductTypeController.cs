...
namespace SSH.API.Controller
{
    ...
    public class ProductTypeController : Controller<IProductTypeService, ProductTypeDTO, ProductType, int>
    {
        ...
        [HttpPost]
        [Route("Create")]
        public async Task<ResponseMessageResult> CreateProductType(ProductTypeDTO dtoObject)
        {
        ...
        [HttpPut]
        [Route("Update")]
        public async Task<ResponseMessageResult> UpdateProductType(ProductTypeDTO dtoObject)
        {
        ...
        [HttpDelete]
        [Route("Delete")]
        public async Task<ResponseMessageResult> DeleteProductType(int id)
        {
