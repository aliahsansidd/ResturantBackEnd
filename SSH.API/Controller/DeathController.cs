...
namespace SSH.API.Controller
{
    [CustomAuthorize]
    [RoutePrefix("Death")]
    public class DeathController : Controller<IDeathService, DeathDTO, Death, int>
    {
        public DeathController(IDeathService service)
            : base(service)
        {
        }
        ...
        [HttpPost]
        [Route("Create")]
        public async Task<ResponseMessageResult> CreateDeath(DeathDTO dtoObject)
        {
        ...
        [HttpPut]
        [Route("Update")]
        public async Task<ResponseMessageResult> UpdateDeath(DeathDTO dtoObject)
        {
        ...
        [HttpDelete]
        [Route("Delete")]
        public async Task<ResponseMessageResult> DeleteDeath(int id)
        {
