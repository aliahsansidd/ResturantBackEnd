...
{
    [CustomAuthorize]
    [RoutePrefix("OrganizationalDivisionDepartment")]
    public class OrganizationalDivisionDepartmentController : Controller<IOrganizationalDivisionDepartmentService, OrganizationalDivisionDepartmentDTO, OrganizationalDivisionDepartment, int>
    {
        public OrganizationalDivisionDepartmentController(IOrganizationalDivisionDepartmentService service)
            : base(service)
        {
        }
        ...
        [HttpPost]
        [Route("Create")]
        public async Task<ResponseMessageResult> CreateOrganizationalDivisionDep(OrganizationalDivisionDepartmentDTO dtoObject)
        {
        ...
        [HttpPut]
        [Route("Update")]
        public async Task<ResponseMessageResult> UpdateOrganizationalDivisionDep(OrganizationalDivisionDepartmentDTO dtoObject)
        {
