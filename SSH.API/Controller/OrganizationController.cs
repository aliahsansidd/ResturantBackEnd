...
namespace SSH.API.Controller
{
    ...
    public class OrganizationController : Controller<IOrganizationService, OrganizationDTO, Organization, int>
    {
        ...
        [HttpPost]
        [Route("Create")]
        public async Task<ResponseMessageResult> CreateOrganization(OrganizationDTO dtoObject)
        {
        ...
        [HttpPut]
        [Route("Update")]
        public async Task<ResponseMessageResult> UpdateOrganization(OrganizationDTO dtoObject)
        {
