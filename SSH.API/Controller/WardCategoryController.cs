...
{
    [CustomAuthorize]
    [RoutePrefix("WardCategory")]
    public class WardCategoryController : Controller<IWardCategoryService, WardCategoryDTO, WardCategory, int>
    {
        public WardCategoryController(IWardCategoryService service)
            : base(service)
        {
        }
        ...
        [HttpPost]
        [Route("Create")]
        public async Task<ResponseMessageResult> CreateWardCategory(WardCategoryDTO dtoObject)
        {
        ...
        [HttpPut]
        [Route("Update")]
        public async Task<ResponseMessageResult> UpdateWardCategory(WardCategoryDTO dtoObject)
        {
        ...
        [HttpDelete]
        [Route("Delete")]
        public async Task<ResponseMessageResult> DeleteWardCategory(int id)
        {
