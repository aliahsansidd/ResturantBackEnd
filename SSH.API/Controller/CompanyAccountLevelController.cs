...
{
    [CustomAuthorize]
    [RoutePrefix("CompanyAccountLevel")]
    public class CompanyAccountLevelController : Controller<ICompanyAccountLevelService, CompanyAccountLevelDTO, CompanyAccountLevel, int>
    {
        public CompanyAccountLevelController(ICompanyAccountLevelService service)
            : base(service)
        {
        }
        ...
        [HttpPost]
        [Route("Create")]
        public async Task<ResponseMessageResult> CreateCompanyAccountLevel(CompanyAccountLevelDTO dtoObject)
        {
        ...
        [HttpPut]
        [Route("Update")]
        public async Task<ResponseMessageResult> UpdateCompanyAccountLevel(CompanyAccountLevelDTO dtoObject)
        {
        ...
        [HttpDelete]
        [Route("Delete")]
        public async Task<ResponseMessageResult> DeleteCompanyAccountLevel(int id)
        {
