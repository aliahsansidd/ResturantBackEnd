...
{
    [CustomAuthorize]
    [RoutePrefix("ProductChemical")]
    public class ProductChemicalController : Controller<IProductChemicalService, ProductChemicalDTO, ProductChemical, int>
    {
        public ProductChemicalController(IProductChemicalService service)
            : base(service)
        {
        }
        ...
        [HttpPost]
        [Route("Create")]
        public async Task<ResponseMessageResult> CreateProductChemical(ProductChemicalDTO dtoObject)
        {
        ...
        [HttpPut]
        [Route("Update")]
        public async Task<ResponseMessageResult> UpdateProductChemical(ProductChemicalDTO dtoObject)
        {
        ...
        [HttpDelete]
        [Route("Delete")]
        public async Task<ResponseMessageResult> DeleteProductChemical(int id)
        {
