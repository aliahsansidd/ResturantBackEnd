...
{
    [CustomAuthorize]
    [RoutePrefix("ClientType")]
    public class ClientTypeController : Controller<IClientTypeService, ClientTypeDTO, ClientType, int>
    {
        ...
        [HttpPost]
        [Route("Create")]
        public async Task<ResponseMessageResult> CreateClientType(ClientTypeDTO dtoObject)
        {
        ...
        [HttpPut]
        [Route("Update")]
        public async Task<ResponseMessageResult> UpdateClientType(ClientTypeDTO dtoObject)
        {
