...
namespace SSH.API.Controller
{
    ...
    public class ClientGroupController : Controller<IClientGroupService, ClientGroupDTO, ClientGroup, int>
    {
        public ClientGroupController(IClientGroupService service)
            : base(service)
        {
        }
        ...
        [HttpPost]
        [Route("Create")]
        public async Task<ResponseMessageResult> CreateBed(ClientGroupDTO dtoObject)
        {
        ...
        [HttpPut]
        [Route("Update")]
        public async Task<ResponseMessageResult> UpdateBed(ClientGroupDTO dtoObject)
        {
