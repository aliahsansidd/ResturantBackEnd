...
{
    [CustomAuthorize]
    [RoutePrefix("LabTestOrderDetail")]
    public class LabTestOrderDetailController : Controller<ILabTestOrderDetailService, LabTestOrderDetailDTO, LabTestOrderDetail, int>
    {
        public LabTestOrderDetailController(ILabTestOrderDetailService service)
            : base(service)
        {
        }
        ...
        [HttpPost]
        [Route("Create")]
        public async Task<ResponseMessageResult> CreateLabTestOrderDetail(LabTestOrderDetailDTO dtoObject)
        {
        ...
        [HttpPut]
        [Route("Update")]
        public async Task<ResponseMessageResult> UpdateLabTestOrderDetail(LabTestOrderDetailDTO dtoObject)
        {
        ...
        [HttpDelete]
        [Route("Delete")]
        public async Task<ResponseMessageResult> DeleteLabTestOrderDetail(int id)
        {
