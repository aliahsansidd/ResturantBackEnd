...
namespace SSH.API.Controller
{
    [CustomAuthorize]
    [RoutePrefix("Brand")]
    public class BrandController : Controller<IBrandService, BrandDTO, Brand, int>
    {
        ...
        [HttpPost]
        [Route("Create")]
        public async Task<ResponseMessageResult> CreateBrand(BrandDTO dtoObject)
        {
        ...
        [HttpPut]
        [Route("Update")]
        public async Task<ResponseMessageResult> UpdateBrand(BrandDTO dtoObject)
        {
        ...
        [HttpDelete]
        [Route("Delete")]
        public async Task<ResponseMessageResult> DeleteBrand(int id)
        {
