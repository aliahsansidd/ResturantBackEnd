...
{
    [CustomAuthorize]
    [RoutePrefix("IncomeGroup")]
    public class IncomeGroupController : Controller<IIncomeGroupService, IncomeGroupDTO, IncomeGroup, int>
    {
        public IncomeGroupController(IIncomeGroupService service)
            : base(service)
        {
        }
        ...
        [HttpPost]
        [Route("Create")]
        public async Task<ResponseMessageResult> CreateIncomeGroup(IncomeGroupDTO dtoObject)
        {
        ...
        [HttpPut]
        [Route("Update")]
        public async Task<ResponseMessageResult> UpdateIncomeGroup(IncomeGroupDTO dtoObject)
        {
        ...
        [HttpDelete]
        [Route("Delete")]
        public async Task<ResponseMessageResult> DeleteIncomeGroup(int id)
        {
