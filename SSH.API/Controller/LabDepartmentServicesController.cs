...
{
    [CustomAuthorize]
    [RoutePrefix("LabDepartmentServices")]
    public class LabDepartmentServicesController : Controller<ILabDepartmentServicesService, LabDepartmentServicesDTO, LabDepartmentServices, int>
    {
        public LabDepartmentServicesController(ILabDepartmentServicesService service)
            : base(service)
        {
        }
        ...
        [HttpPost]
        [Route("Create")]
        public async Task<ResponseMessageResult> CreateLabDepartmentServices(LabDepartmentServicesDTO dtoObject)
        {
        ...
        [HttpPut]
        [Route("Update")]
        public async Task<ResponseMessageResult> UpdateLabDepartmentServices(LabDepartmentServicesDTO dtoObject)
        {
        ...
        [HttpDelete]
        [Route("Delete")]
        public async Task<ResponseMessageResult> DeleteLabDepartmentServices(int id)
        {
