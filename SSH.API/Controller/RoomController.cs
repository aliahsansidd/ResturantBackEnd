...
namespace SSH.API.Controller
{
    [CustomAuthorize]
    [RoutePrefix("Room")]
    public class RoomController : Controller<IRoomService, RoomDTO, Room, int>
    {
        ...
        [HttpPost]
        [Route("Create")]
        public async Task<ResponseMessageResult> CreateRoom(RoomDTO dtoObject)
        {
        ...
        [HttpPut]
        [Route("Update")]
        public async Task<ResponseMessageResult> UpdateRoom(RoomDTO dtoObject)
        {
        ...
        [HttpDelete]
        [Route("Delete")]
        public async Task<ResponseMessageResult> DeleteRoom(int id)
        {
