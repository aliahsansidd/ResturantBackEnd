...
namespace SSH.API.Controller
{
    ...
    public class InventoryItemController : Controller<IInventoryItemService, InventoryItemDTO, InventoryItem, int>
    {
        ...
        [HttpPost]
        [Route("Create")]
        public async Task<ResponseMessageResult> CreateInventoryItem(InventoryItemDTO dtoObject)
        {
        ...
        [HttpPut]
        [Route("Update")]
        public async Task<ResponseMessageResult> UpdateInventoryItem(InventoryItemDTO dtoObject)
        {
        ...
        [HttpDelete]
        [Route("Delete")]
        public async Task<ResponseMessageResult> DeleteInventoryItem(int id)
        {
