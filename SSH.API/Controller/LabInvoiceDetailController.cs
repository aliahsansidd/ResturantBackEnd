...
{
    [CustomAuthorize]
    [RoutePrefix("LabInvoiceDetail")]
    public class LabInvoiceDetailController : Controller<ILabInvoiceDetailService, LabInvoiceDetailDTO, LabInvoiceDetail, int>
    {
        public LabInvoiceDetailController(ILabInvoiceDetailService service)
            : base(service)
        {
        }
        ...
        [HttpPost]
        [Route("Create")]
        public async Task<ResponseMessageResult> CreateLabInvoiceDetail(LabInvoiceDetailDTO dtoObject)
        {
        ...
        [HttpPut]
        [Route("Update")]
        public async Task<ResponseMessageResult> UpdateLabInvoiceDetail(LabInvoiceDetailDTO dtoObject)
        {
        ...
        [HttpDelete]
        [Route("Delete")]
        public async Task<ResponseMessageResult> DeleteLabInvoiceDetail(int id)
        {
