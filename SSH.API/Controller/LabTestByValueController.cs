...
{
    [CustomAuthorize]
    [RoutePrefix("LabTestByValue")]
    public class LabTestByValueController : Controller<ILabTestByValueService, LabTestByValueDTO, LabTestByValue, int>
    {
        public LabTestByValueController(ILabTestByValueService service)
            : base(service)
        {
        }
        ...
        [HttpPost]
        [Route("Create")]
        public async Task<ResponseMessageResult> CreateLabTestByValue(LabTestByValueDTO dtoObject)
        {
        ...
        [HttpPut]
        [Route("Update")]
        public async Task<ResponseMessageResult> UpdateLabTestByValue(LabTestByValueDTO dtoObject)
        {
        ...
        [HttpDelete]
        [Route("Delete")]
        public async Task<ResponseMessageResult> DeleteLabTestByValue(int id)
        {
