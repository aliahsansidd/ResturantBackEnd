...
{
    [CustomAuthorize]
    [RoutePrefix("TestParameter")]
    public class TestParameterController : Controller<ITestParameterService, TestParameterDTO, TestParameter, int>
    {
        ...
        [HttpPost]
        [Route("Create")]
        public async Task<ResponseMessageResult> CreateTestParameter(TestParameterDTO dtoObject)
        {
        ...
        [HttpPut]
        [Route("Update")]
        public async Task<ResponseMessageResult> UpdateTestParameter(TestParameterDTO dtoObject)
        {
        ...
        [HttpDelete]
        [Route("Delete")]
        public async Task<ResponseMessageResult> DeleteTestParameter(int id)
        {
