...
{
    [CustomAuthorize]
    [RoutePrefix("OrganizationalDivision")]
    public class OrganizationalDivisionController : Controller<IOrganizationalDivisionService, OrganizationalDivisionDTO, OrganizationalDivision, int>
    {
        public OrganizationalDivisionController(IOrganizationalDivisionService service)
            : base(service)
        {
        }
        ...
        [HttpPost]
        [Route("Create")]
        public async Task<ResponseMessageResult> CreateOrganizationalDivision(OrganizationalDivisionDTO dtoObject)
        {
        ...
        [HttpPut]
        [Route("Update")]
        public async Task<ResponseMessageResult> UpdateOrganizationalDivision(OrganizationalDivisionDTO dtoObject)
        {
