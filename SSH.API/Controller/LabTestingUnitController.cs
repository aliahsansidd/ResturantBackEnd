...
{
    [CustomAuthorize]
    [RoutePrefix("LabTestingUnit")]
    public class LabTestingUnitController : Controller<ILabTestingUnitService, LabTestingUnitDTO, LabTestingUnit, int>
    {
        public LabTestingUnitController(ILabTestingUnitService service)
            : base(service)
        {
        }
        ...
        [HttpPost]
        [Route("Create")]
        public async Task<ResponseMessageResult> CreateLabTestingUnit(LabTestingUnitDTO dtoObject)
        {
        ...
        [HttpPut]
        [Route("Update")]
        public async Task<ResponseMessageResult> UpdateLabTestingUnit(LabTestingUnitDTO dtoObject)
        {
        ...
        [HttpDelete]
        [Route("Delete")]
        public async Task<ResponseMessageResult> DeleteLabTestingUnit(int id)
        {
