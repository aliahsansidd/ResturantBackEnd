...
{
    [CustomAuthorize]
    [RoutePrefix("CatastrophicEvent")]
    public class CatastrophicEventController : Controller<ICatastrophicEventService, CatastrophicEventDTO, CatastrophicEvent, int>
    {
        public CatastrophicEventController(ICatastrophicEventService service)
            : base(service)
        {
        }
        ...
        [HttpPost]
        [Route("Create")]
        public async Task<ResponseMessageResult> CreateCatastrophicEvent(CatastrophicEventDTO dtoObject)
        {
        ...
        [HttpPut]
        [Route("Update")]
        public async Task<ResponseMessageResult> UpdateCatastrophicEvent(CatastrophicEventDTO dtoObject)
        {
