...
{
    [CustomAuthorize]
    [RoutePrefix("LabTestOrder")]
    public class LabTestOrderController : Controller<ILabTestOrderService, LabTestOrderDTO, LabTestOrder, int>
    {
        public LabTestOrderController(ILabTestOrderService service)
            : base(service)
        {
        }
        ...
        [HttpPost]
        [Route("Create")]
        public async Task<ResponseMessageResult> CreateLabTestOrder(LabTestOrderDTO dtoObject)
        {
        ...
        [HttpPut]
        [Route("Update")]
        public async Task<ResponseMessageResult> UpdateLabTestOrder(LabTestOrderDTO dtoObject)
        {
        ...
        [HttpDelete]
        [Route("Delete")]
        public async Task<ResponseMessageResult> DeleteLabTestOrder(int id)
        {
