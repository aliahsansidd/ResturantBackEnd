...
{
    [CustomAuthorize]
    [RoutePrefix("CPTCategory")]
    public class CPTCategoryController : Controller<ICPTCategoryService, CPTCategoryDTO, CPTCategory, int>
    {
        public CPTCategoryController(ICPTCategoryService service)
            : base(service)
        {
        }
        ...
        [HttpPost]
        [Route("Create")]
        public async Task<ResponseMessageResult> CreateCPTCategory(CPTCategoryDTO dtoObject)
        {
        ...
        [HttpPut]
        [Route("Update")]
        public async Task<ResponseMessageResult> UpdateCPTCategory(CPTCategoryDTO dtoObject)
        {
