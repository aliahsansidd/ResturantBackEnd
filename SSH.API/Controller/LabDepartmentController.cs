...
{
    [CustomAuthorize]
    [RoutePrefix("LabDepartment")]
    public class LabDepartmentController : Controller<ILabDepartmentService, LabDepartmentDTO, LabDepartment, int>
    {
        public LabDepartmentController(ILabDepartmentService service)
            : base(service)
        {
        }
        ...
        [HttpPost]
        [Route("Create")]
        public async Task<ResponseMessageResult> CreateLabDepartment(LabDepartmentDTO dtoObject)
        {
        ...
        [HttpPut]
        [Route("Update")]
        public async Task<ResponseMessageResult> UpdateLabDepartment(LabDepartmentDTO dtoObject)
        {
        ...
        [HttpDelete]
        [Route("Delete")]
        public async Task<ResponseMessageResult> DeleteLabDepartment(int id)
        {
