...
{
    [CustomAuthorize]
    [RoutePrefix("InsuranceCompanies")]
    public class InsuranceCompaniesController : Controller<IInsuranceCompaniesService, InsuranceCompaniesDTO, InsuranceCompanies, int>
    {
        public InsuranceCompaniesController(IInsuranceCompaniesService service)
            : base(service)
        {
        }
        ...
        [HttpPost]
        [Route("Create")]
        public async Task<ResponseMessageResult> CreateInsuranceCompanies(InsuranceCompaniesDTO dtoObject)
        {
        ...
        [HttpPut]
        [Route("Update")]
        public async Task<ResponseMessageResult> UpdateInsuranceCompanies(InsuranceCompaniesDTO dtoObject)
        {
        ...
        [HttpDelete]
        [Route("Delete")]
        public async Task<ResponseMessageResult> DeleteInsuranceCompanies(int id)
        {
