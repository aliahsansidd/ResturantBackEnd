...
{
    [CustomAuthorize]
    [RoutePrefix("LabInvoice")]
    public class LabInvoiceController : Controller<ILabInvoiceService, LabInvoiceDTO, LabInvoice, int>
    {
        public LabInvoiceController(ILabInvoiceService service)
            : base(service)
        {
        }
        ...
        [HttpPost]
        [Route("Create")]
        public async Task<ResponseMessageResult> CreateLabInvoice(LabInvoiceDTO dtoObject)
        {
        ...
        [HttpPut]
        [Route("Update")]
        public async Task<ResponseMessageResult> UpdateLabInvoice(LabInvoiceDTO dtoObject)
        {
        ...
        [HttpDelete]
        [Route("Delete")]
        public async Task<ResponseMessageResult> DeleteLabInvoice(int id)
        {
