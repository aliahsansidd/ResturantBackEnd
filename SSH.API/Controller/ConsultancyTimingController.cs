...
{
    [CustomAuthorize]
    [RoutePrefix("ConsultancyTiming")]
    public class ConsultancyTimingController : Controller<IConsultancyTimingService, ConsultancyTimingDTO, ConsultancyTiming, int>
    {
        public ConsultancyTimingController(IConsultancyTimingService service)
            : base(service)
        {
        }
        ...
        [HttpPost]
        [Route("Create")]
        public async Task<ResponseMessageResult> CreateConsultancyTiming(ConsultancyTimingDTO dtoObject)
        {
        ...
        [HttpPut]
        [Route("Update")]
        public async Task<ResponseMessageResult> UpdateConsultancyTiming(ConsultancyTimingDTO dtoObject)
        {
        ...
        [HttpDelete]
        [Route("Delete")]
        public async Task<ResponseMessageResult> DeleteConsultancyTiming(int id)
        {
