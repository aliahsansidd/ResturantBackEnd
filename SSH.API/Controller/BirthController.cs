...
namespace SSH.API.Controller
{
    [CustomAuthorize]
    [RoutePrefix("Birth")]
    public class BirthController : Controller<IBirthService, BirthDTO, Birth, int>
    {
        public BirthController(IBirthService service)
            : base(service)
        {
        }
        ...
        [HttpPost]
        [Route("Create")]
        public async Task<ResponseMessageResult> CreateBirth(BirthDTO dtoObject)
        {
        ...
        [HttpPut]
        [Route("Update")]
        public async Task<ResponseMessageResult> UpdateBirth(BirthDTO dtoObject)
        {
        ...
        [HttpDelete]
        [Route("Delete")]
        public async Task<ResponseMessageResult> DeleteBirth(int id)
        {
