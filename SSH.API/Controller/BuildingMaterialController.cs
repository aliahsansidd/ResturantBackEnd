...
{
    [CustomAuthorize]
    [RoutePrefix("BuildingMaterial")]
    public class BuildingMaterialController : Controller<IBuildingMaterialService, BuildingMaterialDTO, BuildingMaterial, int>
    {
        public BuildingMaterialController(IBuildingMaterialService service)
            : base(service)
        {
        }
        ...
        [HttpPost]
        [Route("Create")]
        public async Task<ResponseMessageResult> CreateBuildingMaterial(BuildingMaterialDTO dtoObject)
        {
        ...
        [HttpPut]
        [Route("Update")]
        public async Task<ResponseMessageResult> UpdateBuildingMaterial(BuildingMaterialDTO dtoObject)
        {
        ...
        [HttpDelete]
        [Route("Delete")]
        public async Task<ResponseMessageResult> DeleteBuildingMaterial(int id)
        {
