...
{
    [CustomAuthorize]
    [RoutePrefix("CompanyAccount")]
    public class CompanyAccountController : Controller<ICompanyAccountService, CompanyAccountDTO, CompanyAccount, int>
    {
        public CompanyAccountController(ICompanyAccountService service)
            : base(service)
        {
        }
        ...
        [HttpPost]
        [Route("Create")]
        public async Task<ResponseMessageResult> CreateCompanyAccount(CompanyAccountDTO dtoObject)
        {
        ...
        [HttpPut]
        [Route("Update")]
        public async Task<ResponseMessageResult> UpdateCompanyAccount(CompanyAccountDTO dtoObject)
        {
        ...
        [HttpDelete]
        [Route("Delete")]
        public async Task<ResponseMessageResult> DeleteCompanyAccount(int id)
        {
