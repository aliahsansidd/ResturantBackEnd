...
{
    [CustomAuthorize]
    [RoutePrefix("LabSampleType")]
    public class LabSampleTypeController : Controller<ILabSampleTypeService, LabSampleTypeDTO, LabSampleType, int>
    {
        public LabSampleTypeController(ILabSampleTypeService service)
            : base(service)
        {
        }
        ...
        [HttpPost]
        [Route("Create")]
        public async Task<ResponseMessageResult> CreateLabSampleType(LabSampleTypeDTO dtoObject)
        {
        ...
        [HttpPut]
        [Route("Update")]
        public async Task<ResponseMessageResult> UpdateLabSampleType(LabSampleTypeDTO dtoObject)
        {
        ...
        [HttpDelete]
        [Route("Delete")]
        public async Task<ResponseMessageResult> DeleteLabSampleType(int id)
        {
