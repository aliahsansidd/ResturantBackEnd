...
namespace SSH.API.Controller
{
    [CustomAuthorize]
    [RoutePrefix("Racks")]
    public class RacksController : Controller<IRacksService, RacksDTO, Racks, int>
    {
        public RacksController(IRacksService service)
            : base(service)
        {
        }
        ...
        [HttpPost]
        [Route("Create")]
        public async Task<ResponseMessageResult> CreateRacks(RacksDTO dtoObject)
        {
        ...
        [HttpPut]
        [Route("Update")]
        public async Task<ResponseMessageResult> UpdateRacks(RacksDTO dtoObject)
        {
        ...
        [HttpDelete]
        [Route("Delete")]
        public async Task<ResponseMessageResult> DeleteRacks(int id)
        {
