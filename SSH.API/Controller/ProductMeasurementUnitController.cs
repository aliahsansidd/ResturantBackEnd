...
{
    [CustomAuthorize]
    [RoutePrefix("ProductMeasurementUnit")]
    public class ProductMeasurementUnitController : Controller<IProductMeasurementUnitService, ProductMeasurementUnitDTO, ProductMeasurementUnit, int>
    {
        public ProductMeasurementUnitController(IProductMeasurementUnitService service)
            : base(service)
        {
        }
        ...
        [HttpPost]
        [Route("Create")]
        public async Task<ResponseMessageResult> CreateProductMeasurementUnit(ProductMeasurementUnitDTO dtoObject)
        {
        ...
        [HttpPut]
        [Route("Update")]
        public async Task<ResponseMessageResult> UpdateProductMeasurementUnit(ProductMeasurementUnitDTO dtoObject)
        {
        ...
        [HttpDelete]
        [Route("Delete")]
        public async Task<ResponseMessageResult> DeleteProductMeasurementUnit(int id)
        {
